...
restore_on_node() {
    ...
    marker "START" "Restore application filesystems for node '${node:-local}'"
    ...
    marker "END" "Restore application filesystems for node '${node:-local}'"
}
